...
package com.google.samples.apps.sunflower.features.plantlist.presentation.vm
...
import com.google.samples.apps.sunflower.features.plantlist.presentation.ui.PlantListFragment
...
class PlantListViewModel @Inject internal constructor(
    ...
    private val getPlantsWithGrowZoneNumberUseCase: GetPlantsWithGrowZoneNumberUseCase,
    ...
    val plants: LiveData<List<Plant>> = growZone.flatMapLatest { zone ->
        if (zone == NO_GROW_ZONE) {
            ...
            getPlantsWithGrowZoneNumberUseCase.execute(zone)
        }
    }.asLiveData()
